...
@section('content')
    <main class="container">
        ...
        <div class="publish-btn my-2">
            ...
            <button class="btn btn-primary px-4" type="button" data-bs-toggle="modal" @if (fs_user()->check()) data-bs-target="#commentModal-{{ $post['pid'] }}" @else data-bs-target="#commentTipModal" @endif>{{ fs_config('publish_comment_name') }}</button>
        </div>
