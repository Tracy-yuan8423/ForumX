                ...
                $('#currentLocation').html(`
                    <div class="row">
                        ...
                        <div class="col text-end">
                            <a href="{{ route('fresns.nearby.comments') }}" role="button" class="btn btn-success"><i class="bi bi-geo-alt-fill"></i> {{ fs_lang('reloadLocation') }}</a>
                        </div>
                    </div>`)
            }
        }
        ...
        function getCommentsByNearby(e) {
            ...
            if (navigator.geolocation) {
                ...
                navigator.geolocation.getCurrentPosition(function (position){
                    ...
                    let url = "{{ route('fresns.nearby.comments') }}";
