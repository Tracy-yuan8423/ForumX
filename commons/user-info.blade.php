<div class="x-user-info me-3 mt-2">
    <div class="d-flex">
        ...
        <a href="{{ fs_route(route('fresns.me.index')) }}">{{ fs_user('detail.nickname') }}</a>
        ...
        <div class="dropdown">
            ...
            <ul class="dropdown-menu">
                {{-- 草稿 --}}
                <li>
                    <a class="dropdown-item text-decoration-none" href="{{ fs_route(route('fresns.me.drafts')) }}">
                ...
                @if (fs_config('wallet_status'))
                    <li><a class="dropdown-item text-decoration-none" href="{{ fs_route(route('fresns.me.wallet')) }}">{{ fs_config('channel_me_wallet_name') }}</a></li>
                @endif
                {{-- 名下用户 --}}
                @if (count(fs_account('detail.users')) > 1)
                    <li><a class="dropdown-item text-decoration-none" href="{{ fs_route(route('fresns.me.users')) }}">{{ fs_config('channel_me_users_name') }}</a></li>
                @endif
            </ul>
        </div>
        <div class="vr mx-2"></div>
        <a href="{{ fs_route(route('fresns.me.settings')) }}">{{ fs_config('channel_me_settings_name') }}</a>
        <div class="vr mx-2"></div>
        ...
        <div class="dropdown">
            ...
            <ul class="dropdown-menu">
                {{-- all notifications --}}
                <li>
                    <a class="dropdown-item text-decoration-none" href="{{ fs_route(route('fresns.notification.index')) }}">
                ...
                @if (in_array('systems', fs_config('fs_forumx_notifications', [])))
                    <li>
                        <a class="dropdown-item text-decoration-none" href="{{ fs_route(route('fresns.notification.index', ['types' => 1])) }}">
                ...
                @if (in_array('recommends', fs_config('fs_forumx_notifications', [])))
                    <li>
                        <a class="dropdown-item text-decoration-none" href="{{ fs_route(route('fresns.notification.index', ['types' => 2])) }}">
                ...
                @if (in_array('likes', fs_config('fs_forumx_notifications', [])))
                    <li>
                        <a class="dropdown-item text-decoration-none" href="{{ fs_route(route('fresns.notification.index', ['types' => 3])) }}">
                ...
                @if (in_array('dislikes', fs_config('fs_forumx_notifications', [])))
                    <li>
                        <a class="dropdown-item text-decoration-none" href="{{ fs_route(route('fresns.notification.index', ['types' => 4])) }}">
                ...
                @if (in_array('follows', fs_config('fs_forumx_notifications', [])))
                    <li>
                        <a class="dropdown-item text-decoration-none" href="{{ fs_route(route('fresns.notification.index', ['types' => 5])) }}">
                ...
                @if (in_array('blocks', fs_config('fs_forumx_notifications', [])))
                    <li>
                        <a class="dropdown-item text-decoration-none" href="{{ fs_route(route('fresns.notification.index', ['types' => 6])) }}">
                ...
                @if (in_array('mentions', fs_config('fs_forumx_notifications', [])))
                    <li>
                        <a class="dropdown-item text-decoration-none" href="{{ fs_route(route('fresns.notification.index', ['types' => 7])) }}">
                ...
                @if (in_array('comments', fs_config('fs_forumx_notifications', [])))
                    <li>
                        <a class="dropdown-item text-decoration-none" href="{{ fs_route(route('fresns.notification.index', ['types' => 8])) }}">
        ...
        <div class="vr mx-2"></div>
        <a href="{{ fs_route(route('fresns.me.logout')) }}">{{ fs_lang('accountLogout') }}</a>
    </div>

    <div class="d-flex mt-2 mt-lg-0">
        <div class="dropdown ms-lg-auto">
            <a class="nav-link dropdown-toggle" href="{{ fs_route(route('fresns.me.extcredits')) }}" role="button" data-bs-toggle="dropdown" aria-expanded="false">{{ fs_user('detail.stats.extcredits1Name') ?? 'Extcredits 1' }}: {{ fs_user('detail.stats.extcredits1') ?? 0 }}</a>
            <ul class="dropdown-menu">
                @if (fs_user('detail.stats.extcredits1State'))
                    <li class="ms-3">
                        <a class="text-decoration-none" href="{{ fs_route(route('fresns.me.extcredits', ['extcreditsId' => 1])) }}">{{ fs_user('detail.stats.extcredits1Name') ?? 'Extcredits 1' }}</a>:
                ...
                @if (fs_user('detail.stats.extcredits2State'))
                    <li class="ms-3">
                        <a class="text-decoration-none" href="{{ fs_route(route('fresns.me.extcredits', ['extcreditsId' => 2])) }}">{{ fs_user('detail.stats.extcredits2Name') ?? 'Extcredits 2' }}</a>:
                ...
                @if (fs_user('detail.stats.extcredits3State'))
                    <li class="ms-3">
                        <a class="text-decoration-none" href="{{ fs_route(route('fresns.me.extcredits', ['extcreditsId' => 3])) }}">{{ fs_user('detail.stats.extcredits3Name') ?? 'Extcredits 3' }}</a>:
                ...
                @if (fs_user('detail.stats.extcredits4State'))
                    <li class="ms-3">
                        <a class="text-decoration-none" href="{{ fs_route(route('fresns.me.extcredits', ['extcreditsId' => 4])) }}">{{ fs_user('detail.stats.extcredits4Name') ?? 'Extcredits 4' }}</a>:
                ...
                @if (fs_user('detail.stats.extcredits5State'))
                    <li class="ms-3">
                        <a class="text-decoration-none" href="{{ fs_route(route('fresns.me.extcredits', ['extcreditsId' => 5])) }}">{{ fs_user('detail.stats.extcredits5Name') ?? 'Extcredits 5' }}</a>:
        ...
        <a href="{{ fs_route(route('fresns.me.index')) }}">{{ fs_config('user_role_name') }}: {{ fs_user('detail.roleName') }}</a>
    </div>
</div>
<div class="x-user-avatar d-none d-sm-block">
    <div class="border rounded shadow-sm" style="padding:2px;">
        <a href="{{ fs_route(route('fresns.me.index')) }}"><img src="{{ fs_user('detail.avatar') }}" loading="lazy" class="rounded" width="48" height="48"></a>
    </div>
</div>
