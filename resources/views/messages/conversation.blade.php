                ...
                <div class="card">
                    ...
                    <div class="card-header">
                        @if ($conversation['user']['status'])
                            <a href="{{ fs_route(route('fresns.profile.index', ['uidOrUsername' => $conversation['user']['uid']])) }}" target="_blank" class="text-decoration-none">
                                ...
                                <span class="ms-2 conversation-user-name text-secondary"><i class="bi bi-person-badge"></i>{{ $conversation['user']['uid'] }}</span>
                            </a>
                        @else
