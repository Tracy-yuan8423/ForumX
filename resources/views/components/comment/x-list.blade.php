        ...
        <div class="ps-3 py-1 fw-semibold" style="border-bottom: 1px dashed #CDCDCD;">
            ...
            @else
                ...
                @if ($comment['author']['verifiedStatus'])
                    ...
                    @else
                        <img src="/assets/ForumX/images/icon-verified.png" loading="lazy" alt="认证图标" data-bs-toggle="tooltip" data-bs-placement="top" title="{{ $comment['author']['verifiedDesc'] }}" height="18">
                    @endif
                @endif
            @endif
        </div>
