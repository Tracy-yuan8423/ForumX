<article class="d-flex col-md-{{ $colNumber }} mb-4">
    <section class="flex-shrink-0">
        <a href="{{ fs_route(route('fresns.group.detail', ['gid' => $group['gid']])) }}">
            ...
            @else
                <img src="/assets/ForumX/images/group-null.png" loading="lazy" alt="{{ $group['gname'] }}" class="rounded list-cover">
            @endif
        </a>
    </section>
    ...
    <div class="flex-grow-1 ms-3">
        ...
        @if ($group['recommend'])
            <img src="/assets/ForumX/images/icon-recommend.png" class="list-recommend ms-1" data-bs-toggle="tooltip" data-bs-placement="top" title="推荐" loading="lazy" alt="推荐">
        @endif
