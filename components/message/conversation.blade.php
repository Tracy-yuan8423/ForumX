<a href="{{ fs_route(route('fresns.conversation.detail', ['uidOrUsername' => $conversation['user']['fsid']])) }}" class="list-group-item list-group-item-action d-flex justify-content-between position-relative">
