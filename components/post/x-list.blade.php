...
<tr>
    <td class="w-75 ps-lg-3">
        ...
        @if ($post['digestState'] == 2)
            <img src="/assets/themes/ForumX/images/icon-digest.png" loading="lazy" alt="一级精华" class="ms-2" height="24">
        @elseif ($post['digestState'] == 3)
            <img src="/assets/themes/ForumX/images/icon-digest.png" loading="lazy" alt="二级精华" class="ms-2" height="24">
        @endif
    </td>
